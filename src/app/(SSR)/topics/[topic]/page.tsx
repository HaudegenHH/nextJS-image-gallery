...
// if you want to allow only the keyword that are pre-fetched:
export const dynamicParams = false;

export function generateStaticParams() {
    // return [{topic: "health"}, "fitness", "coding"];
...
export default async function Page( { params: { topic } }: PageProps) {
    ...
    return (
        <div>
            ...
            rendered on first access and then <strong>cached for subsequent 
            requests</strong> (this can be disabled).
